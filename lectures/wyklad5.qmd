...
## 🎯 Temat: Mechanizmy zapewniania spójności danych i wprowadzenie do widoków

Celem wykładu jest:

- poznanie zasad transakcyjności i właściwości ACID,
- zrozumienie współbieżności i mechanizmów izolacji transakcji,
- zapoznanie się z pojęciem widoków (views) i ich zastosowaniami,
- praktyczne zastosowanie transakcji i widoków w SQL / PL/SQL.
