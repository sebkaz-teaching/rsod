...
```
obie operacje – wstawienie studenta i zmniejszenie liczby miejsc – zostaną zatwierdzone jednocześnie. 

Jeśli jedna się nie powiedzie, można użyć ROLLBACK, aby przywrócić stan poprzedni.
